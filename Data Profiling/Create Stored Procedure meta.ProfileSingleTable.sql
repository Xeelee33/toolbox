/*
Script: Create Stored Procedure meta.ProfileSingleTable.sql
Created by: Joshua Wilshere
Created on: 6/24/25

Stored Procedure Purpose: Creates, or if exists, populates a schema and table called meta.TABLES_PROFILES with a basic profile of the schema and table passed as input parameters

Instructions: 
	1. Execute
	2. To customize the output further, tweak the SELECT * FROM #PROFILE_TABLE at the very end of this script

Usage Example:
EXEC meta.ProfileSingleTable 'dbo','green_tripdata_2020-04_Excel_AllChar'
EXEC meta.ProfileSingleTable @SCHEMA='dbo', @TABLE='green_tripdata_2020-04_Excel_AllChar'
...
CREATE OR ALTER PROCEDURE meta.ProfileSingleTable
(	
	@SCHEMA NVARCHAR(50),
	@TABLE NVARCHAR(100)
)
...
-- Create meta table to hold and output profile results if it doesn't exist
